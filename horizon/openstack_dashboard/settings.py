...
HORIZON_CONFIG = {
    ...
    'angular_modules': [],
    'js_files': ['horizon/js/highcharts.src.js'],
    'js_spec_files': [],
}
...
INSTALLED_APPS = [
    ...
    'horizon',
    'openstack_auth',
    'openstack_dashboard.dashboards.cdn.cdn_domain_manager',
    'openstack_dashboard.dashboards.cdn.cdn_cache_refresh',
    'dashboards.member',#by ying.zhou
]
...
CUSTOM_THEME_PATH = 'static/themes/syscloud'
...
try:
    ...
    logging.warning("Error import local_settings from /etc/openstack-dashboard")
...
#time in minute
GENERATED_CODE_EXPIRE_TIME = 10

NEED_FEE_LIST = ['network_init_modal', 'vpn_init_modal', 'create_cloud_hdd', 'create_snap_from_hdd', 'extend_hdd',
                 'resize_instance__flavor_choice', 'associate_floating_ip_form', 'create_router_form',
                 'update_router_form', 'flavor_choice', 'instance_advanced_options', 'add_ssl_vpn'
                 ]
