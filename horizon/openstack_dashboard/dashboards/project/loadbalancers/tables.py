...
class AddLoadBalanderLink(tables.LinkAction):
    ...
    url = "horizon:project:loadbalancers:addloadbalander"
    classes = ("ajax-modal",)
    icon = "plus"
...
class BackendServerLink(tables.LinkAction):
    ...
    url = "horizon:project:loadbalancers:backendserver"
    classes = ("ajax-modal",)
    icon = "plus"
    policy_rules = (("network", "create_loadbalancer"),)

    def get_link_url(self, pool):
        base_url = reverse("horizon:project:loadbalancers:addbackendserver",
                           kwargs={'pool_id': pool.id})
        return base_url
...
class UpdateLoadBalancerLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    def get_link_url(self, pool):
        base_url = reverse("horizon:project:loadbalancers:updateloadbalancer",
                           kwargs={'pool_id': pool.id})
        return base_url
...
class LoadBalancersTable(tables.DataTable):
    name = tables.Column("name", verbose_name=_("Name"),
                         link="horizon:project:loadbalancers:loadbalancerdetails")
