...
from openstack_dashboard.dashboards.project.virtnic \
...
class IndexView(tables.DataTableView):
    ...
    template_name = 'project/virtnic/index.html'
...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'project/virtnic/create.html'
    success_url = reverse_lazy("horizon:project:virtnic:index")
    page_title = _("Create Virtnic")
    submit_label = _("Create Virtnic")
    submit_url = reverse_lazy("horizon:project:virtnic:create")
...
class BindingView(forms.ModalFormView):
    ...
    template_name = 'project/virtnic/binding.html'
    success_url = reverse_lazy("horizon:project:virtnic:index")
    page_title = _("Binding Virtnic")
    submit_label = _("Binding")
    submit_url = "horizon:project:virtnic:binding"
...
class DetailView(tabs.TabView):
    ...
    template_name = 'project/virtnic/detail.html'
    ...
    def get_redirect_url():
        return reverse_lazy('horizon:project:virtnic:index')
