...
from openstack_dashboard.dashboards.project.virtnic import views


# NETWORKS = r'^(?P<network_id>[^/]+)/%s$'
VIRTNICS = r'^(?P<port_id>[^/]+)/%s'

urlpatterns = patterns(
    '',
    url(r'^$', views.IndexView.as_view(), name='index'),
    url(r'^create$', views.CreateView.as_view(), name='create'),
#     url(r'^binding$', views.BindingView.as_view(), name='binding'))
    url(VIRTNICS % 'binding', views.BindingView.as_view(), name='binding'),
    url(r'^(?P<port_id>[^/]+)/$', views.DetailView.as_view(), name='detail'))
