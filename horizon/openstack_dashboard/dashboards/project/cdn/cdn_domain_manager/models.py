...
class Domain(models.Model):
    ...
    source_type = models.CharField('回源地址类型', max_length=10, null=True)
    status = models.CharField('状态', max_length=20, default='unverified')
    Enable = models.CharField('运行状态', max_length=10)
    current_type = models.CharField('当前记费类型', max_length=10)
    update_type = models.CharField('记费更新类型', max_length=10, null=True)
    ...
    error_log = models.CharField('错误日志', max_length=255, null=True)
