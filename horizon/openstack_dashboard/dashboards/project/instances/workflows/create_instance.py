...
class SetInstanceDetailsAction(workflows.Action):
    ...
    vcpus = forms.ChoiceField(label=_("vCPUs"), help_text=_("Number of vCPUs."))
    memory_mb = forms.ChoiceField(label=_("Memory Size"), help_text=_("Size of memory."))
    ...
    def clean(self):
        ...
        cleaned_data['flavor'] = self.flavor
        return cleaned_data
...
class SetInstanceDetails(workflows.Step):
    ...
    contributes = ("source_type", "source_id",
                   ...
                   'memory_mb', 'vcpus', # Add by zhihao.ding 2015/7/14 for kill_flavor
    ...
    def prepare_action_context(self, request, context):
        if 'source_type' in context and 'source_id' in context:
            ...
            context['source_type'] = 'volume_image_id'
        return context
