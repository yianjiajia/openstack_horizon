...
from openstack_dashboard.dashboards.overview.overview \
...
class IndexView(tables.DataTableView):
    ...
    def get_data(self):
        ...
        if 'asc' == sort_dir:
            tenants = sorted(tenants, key=attrgetter('created_at'), reverse = True)
        # end add pagination
...
class ProjectUsageView(usage.UsageView):
    ...
    csv_template_name = 'overview/overview/usage.csv'
