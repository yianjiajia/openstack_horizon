...
class CreateGroup(tables.LinkAction):
    ...
    url = "horizon:security:security_groups:create"
    classes = ("ajax-modal",)
    icon = "plus"
...
class EditGroup(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:security:security_groups:update"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class ManageRules(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:security:security_groups:detail"
    icon = "pencil"
...
class CreateRule(tables.LinkAction):
    ...
    url = "horizon:security:security_groups:add_rule"
    classes = ("ajax-modal",)
    icon = "plus"
