...
from openstack_dashboard.dashboards.security.security_groups \
    import tabs as project_tabs

class IndexView(tabs.TabbedTableView):
    tab_group_class = project_tabs.SecurityGroupsTabs
    template_name = 'security/security_groups/index.html'
    page_title = _("Key Pairs")


class DetailView(tables.DataTableView):
    table_class = project_tables.RulesTable
    template_name = 'security/security_groups/detail.html'
    ...
    def _get_data(self):
        ...
        try:
            ...
            redirect = reverse('horizon:security:security_groups:index')
...
class UpdateView(forms.ModalFormView):
    ...
    template_name = 'security/security_groups/update.html'
    submit_label = _("Edit Security Group")
    submit_url = "horizon:security:security_groups:update"
    success_url = reverse_lazy('horizon:security:security_groups:index')
    ...
    def get_object(self):
        ...
        try:
            ...
            url = reverse('horizon:security:security_groups:index')
...
class AddRuleView(forms.ModalFormView):
    ...
    template_name = 'security/security_groups/add_rule.html'
    submit_label = _("Add")
    submit_url = "horizon:security:security_groups:add_rule"
    page_title = _("Add Rule")

    def get_success_url(self):
        sg_id = self.kwargs['security_group_id']
        return reverse("horizon:security:"
...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'security/security_groups/create.html'
    submit_label = _("Create Security Group")
    submit_url = reverse_lazy(
        "horizon:security:security_groups:create")
    success_url = reverse_lazy('horizon:security:security_groups:index')
