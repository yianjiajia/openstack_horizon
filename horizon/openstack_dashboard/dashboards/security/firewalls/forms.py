...
class UpdateRule(forms.SelfHandlingForm):
    ...
    failure_url = 'horizon:security:firewalls:index'
    ...
    def handle(self, request, context):
        ...
        try:
            ...
            # operation log
            config = _('Rule ID: %s') % rule_id
            api.logger.Logger(request).create(resource_type='firewall', action_name='Update Firewall Rule',
            ...
            # operation log
            api.logger.Logger(request).create(resource_type='firewall', action_name='Update Firewall Rule',
                                                       resource_name='Firewall', config=msg,
                                                       status='Error')
...
class UpdatePolicy(forms.SelfHandlingForm):
    ...
    def handle(self, request, context):
        ...
        try:
            ...
            # operation log
            config = _('Policy ID: %s') %policy_id
            api.logger.Logger(request).create(resource_type='firewall', action_name='Update Firewall Policy',
                                                       resource_name='Firewall', config=config,
                                                       status='Success')
            return policy
        except Exception as e:
...
class UpdateFirewall(forms.SelfHandlingForm):
    ...
    def handle(self, request, context):
        ...
        try:
            ...
            # operation log
            config = _('Firewall ID: %s') % firewall_id
            api.logger.Logger(request).create(resource_type='firewall', action_name='Update Firewall',
                                                       resource_name='Firewall', config=config,
                                                       status='Success')
            return firewall
        except Exception as e:
...
class InsertRuleToPolicy(forms.SelfHandlingForm):
    ...
    def handle(self, request, context):
        ...
        try:
            ...
            # operation log
            config = _("Rule ID: %s Policy ID: %s") % (insert_rule_id, policy_id)
            api.logger.Logger(request).create(resource_type='firewall', action_name='Insert Rule',
                                                       resource_name='Firewall', config=config,
                                                       status='Success')
            return policy
        except Exception as e:
...
class RemoveRuleFromPolicy(forms.SelfHandlingForm):
    ...
    def handle(self, request, context):
        ...
        try:
            ...
            # operation log
            config = _("Rule ID: %s Policy ID: %s") % (remove_rule_id, policy_id)
            api.logger.Logger(request).create(resource_type='firewall', action_name='Remove Rule From Policy',
                                                       resource_name='Firewall', config=config,
                                                       status='Success')
            return policy
        except Exception as e:
...
class RouterInsertionFormBase(forms.SelfHandlingForm):
    ...
    def handle(self, request, context):
        ...
        try:
            ...
            # operation log
            config = _('Firewall ID: %s') %firewall_id
            api.logger.Logger(request).create(resource_type='firewall', action_name='Select Route',
                                                       resource_name='Firewall', config=config,
                                                       status='Success')
            return firewall
        except Exception as e:
