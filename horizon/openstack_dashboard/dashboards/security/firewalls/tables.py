...
class AddRuleLink(tables.LinkAction):
    ...
    url = "horizon:security:firewalls:addrule"
    classes = ("ajax-modal",)
    icon = "plus"
...
class AddPolicyLink(tables.LinkAction):
    ...
    url = "horizon:security:firewalls:addpolicy"
...
class AddFirewallLink(tables.LinkAction):
    ...
    url = "horizon:security:firewalls:addfirewall"
    classes = ("ajax-modal",)
    icon = "plus"
...
class UpdateRuleLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    def get_link_url(self, rule):
        base_url = reverse("horizon:security:firewalls:updaterule",
...
class UpdatePolicyLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    def get_link_url(self, policy):
        base_url = reverse("horizon:security:firewalls:updatepolicy",
...
class UpdateFirewallLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    def get_link_url(self, firewall):
        base_url = reverse("horizon:security:firewalls:updatefirewall",
...
class InsertRuleToPolicyLink(policy.PolicyTargetMixin,
    ...
    def get_link_url(self, policy):
        base_url = reverse("horizon:security:firewalls:insertrule",
                           kwargs={'policy_id': policy.id})
        return base_url
...
class RemoveRuleFromPolicyLink(policy.PolicyTargetMixin,
    ...
    def get_link_url(self, policy):
        base_url = reverse("horizon:security:firewalls:removerule",
                           kwargs={'policy_id': policy.id})
        return base_url
...
class AddRouterToFirewallLink(policy.PolicyTargetMixin,
    ...
    def get_link_url(self, firewall):
        base_url = reverse("horizon:security:firewalls:addrouter",
                           kwargs={'firewall_id': firewall.id})
        return base_url
...
class RemoveRouterFromFirewallLink(policy.PolicyTargetMixin,
    ...
    def get_link_url(self, firewall):
        base_url = reverse("horizon:security:firewalls:removerouter",
                           kwargs={'firewall_id': firewall.id})
        return base_url
...
def get_policy_link(datum):
    return reverse('horizon:security:firewalls:policydetails',
...
class RulesTable(tables.DataTable):
    ...
    name = tables.Column("name_or_id",
                         verbose_name=_("Name"),
                         link="horizon:security:firewalls:ruledetails")
...
class PoliciesTable(tables.DataTable):
    name = tables.Column("name_or_id",
                         verbose_name=_("Name"),
                         link="horizon:security:firewalls:policydetails")
...
class FirewallsTable(tables.DataTable):
    ...
    name = tables.Column("name_or_id",
                         verbose_name=_("Name"),
                         link="horizon:security:firewalls:firewalldetails")
