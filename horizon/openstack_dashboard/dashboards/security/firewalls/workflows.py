...
class AddRule(workflows.Workflow):
    ...
    success_url = "horizon:security:firewalls:index"
    ...
    def handle(self, request, context):
        try:
            ...
            # operation log
            config = _('Rule Name: %s') % context.get('name','')
            api.logger.Logger(request).create(resource_type='firewall', action_name='Create Firewall Rule',
...
class SelectRulesStep(workflows.Step):
    ...
    template_name = "security/firewalls/_update_rules.html"
...
class SelectRoutersStep(workflows.Step):
    ...
    template_name = "security/firewalls/_update_routers.html"
...
class AddPolicy(workflows.Workflow):
    ...
    def handle(self, request, context):
        try:
            ...
            # operation log
            config = _('Policy Name: %s') % context.get('name','')
            api.logger.Logger(request).create(resource_type='firewall', action_name='Create Firewall Policy',
                                                       resource_name='Firewall', config=config,
                                                       status='Success')
            return True
        except Exception as e:
...
class AddFirewall(workflows.Workflow):
    ...
    def handle(self, request, context):
        try:
            ...
            # operation log
            config = _('Firewall Name: %s') % context.get('name','')
