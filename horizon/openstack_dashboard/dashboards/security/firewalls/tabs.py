...
from openstack_dashboard.dashboards.security.firewalls import tables
...
class RuleDetailsTab(tabs.Tab):
    ...
    slug = "ruledetails"
    template_name = "security/firewalls/_rule_details.html"
    failure_url = reverse_lazy('horizon:security:firewalls:index')
...
class PolicyDetailsTab(tabs.Tab):
    ...
    slug = "policydetails"
    template_name = "security/firewalls/_policy_details.html"
    failure_url = reverse_lazy('horizon:security:firewalls:index')
...
class FirewallDetailsTab(tabs.Tab):
    ...
    template_name = "security/firewalls/_firewall_details.html"
    failure_url = reverse_lazy('horizon:security:firewalls:index')
