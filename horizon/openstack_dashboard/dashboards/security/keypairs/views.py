...
from openstack_dashboard.dashboards.security.keypairs \
...
class IndexView(tabs.TabbedTableView):
    tab_group_class = project_tabs.KeypariTabs
    template_name = 'security/keypairs/index.html'
...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'security/keypairs/create.html'
    submit_label = _("Create Key Pair")
    submit_url = reverse_lazy(
        "horizon:security:keypairs:create")
    success_url = 'horizon:security:keypairs:download'
...
class ImportView(forms.ModalFormView):
    ...
    template_name = 'security/keypairs/import.html'
    submit_label = _("Import Key Pair")
    submit_url = reverse_lazy(
        "horizon:security:keypairs:import")
    success_url = reverse_lazy('horizon:security:keypairs:index')
...
class DetailView(views.HorizonTemplateView):
    template_name = 'security/keypairs/detail.html'
    ...
    def _get_data(self):
        try:
            ...
            redirect = reverse('horizon:security:keypairs:index')
...
class DownloadView(views.HorizonTemplateView):
    template_name = 'security/keypairs/download.html'
