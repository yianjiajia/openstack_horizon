...
from openstack_dashboard.dashboards.network.routers\
    import forms as project_forms
from openstack_dashboard.dashboards.network.routers import tables as rtables
from openstack_dashboard.dashboards.network.routers import tabs as rdtabs


class IndexView(tables.DataTableView):
    table_class = rtables.RoutersTable
    template_name = 'network/routers/index.html'
...
class DetailView(tabs.TabbedTableView):
    ...
    template_name = 'network/routers/detail.html'
    failure_url = reverse_lazy('horizon:network:routers:index')
...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'network/routers/create.html'
    success_url = reverse_lazy("horizon:network:routers:index")
    page_title = _("Create Router")
    submit_label = _("Create Router")
    submit_url = reverse_lazy("horizon:network:routers:create")
...
class UpdateView(forms.ModalFormView):
    ...
    submit_url = "horizon:network:routers:update"
