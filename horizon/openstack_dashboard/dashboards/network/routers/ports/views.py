...
from openstack_dashboard.dashboards.network.routers.ports \
...
class AddInterfaceView(forms.ModalFormView):
    ...
    template_name = 'network/routers/ports/create.html'
    success_url = 'horizon:network:routers:detail'
...
class SetGatewayView(forms.ModalFormView):
    ...
    template_name = 'network/routers/ports/setgateway.html'
    success_url = 'horizon:network:routers:index'
