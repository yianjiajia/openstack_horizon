...
urlpatterns = patterns(
    ...
    url(r'^addsslvpnconnection$',
        views.AddSSLVPNConnectionView.as_view(), name='addsslvpnconnection'),
    url(r'^update_sslvpnconnection/(?P<sslvpnconnection_id>[^/]+)/$',
        views.UpdateSSLVPNConnectionView.as_view(), name='update_sslvpnconnection'),
    url(r'^addsslvpncredential$',
        views.AddVPNCredentialView.as_view(), name='addsslvpncredential'),
    url(r'^update_vpncredential/(?P<vpncredential_id>[^/]+)/$',
        views.UpdateVPNCredentialView.as_view(), name='update_vpncredential'),                       
    url(r'^sslvpncredential/(?P<vpncredential_id>[^/]+)/$',
        views.VPNCredentialDetailsView.as_view(), name='sslvpncredentialdetails'),
    url(r'^sslvpnconnection/(?P<sslvpnconnection_id>[^/]+)/$',
        views.SSLVPNConnectionDetailsView.as_view(),
        name='sslvpnconnectiondetails'),
    url(r'^donwload_ovpn/(?P<sslvpnconnection_id>[^/]+)/$',
        views.DownloadOvpnFileView.as_view(), name='donwload_ovpn'),
    url(r'^addikepolicy$',
