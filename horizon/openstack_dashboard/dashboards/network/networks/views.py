...
from openstack_dashboard.dashboards.network.networks \
    import forms as project_forms
from openstack_dashboard.dashboards.network.networks.ports \
    import tables as port_tables
from openstack_dashboard.dashboards.network.networks.subnets \
...
class IndexView(tables.DataTableView):
    ...
    template_name = 'network/networks/index.html'
...
class CreateView(workflows.WorkflowView):
    ...
    ajax_template_name = 'network/networks/create.html'
...
class UpdateView(forms.ModalFormView):
    ...
    submit_url = "horizon:network:networks:update"
    success_url = reverse_lazy("horizon:network:networks:index")
    template_name = 'network/networks/update.html'
...
class DetailView(tables.MultiTableView):
    ...
    template_name = 'network/networks/detail.html'
    page_title = _("Network Details")
    ...
    def get_redirect_url():
        return reverse_lazy('horizon:network:networks:index')
