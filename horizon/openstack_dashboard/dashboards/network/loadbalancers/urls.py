...
urlpatterns = patterns(
    ...
    url(r'^addloadbalander$',
        views.AddLoadBalancerView.as_view(), name='addloadbalander'),
    url(r'^updateloadbalancer/(?P<pool_id>[^/]+)/$',
        views.UpdateLoadBalancerView.as_view(), name='updateloadbalancer'),
    url(r'^loadbalancers/(?P<pool_id>[^/]+)/$',
        views.LoadBalancerDetailsView.as_view(), name='loadbalancerdetails'),
    url(r'^addbackendserver/(?P<pool_id>[^/]+)',
        views.BackendServerView.as_view(), name='addbackendserver'))