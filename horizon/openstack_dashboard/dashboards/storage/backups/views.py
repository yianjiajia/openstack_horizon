...
from openstack_dashboard.dashboards.storage.backups \
...
class IndexView(tabs.TabbedTableView):
    tab_group_class = backup_tabs.BackupTableTabs
    template_name = 'storage/backups/index.html'
...
class BackupDetailView(tabs.TabView):
    ...
    page_title = _("Volume Backup Details")
