...
class CreateSnapshotView(forms.ModalFormView):
    ...
    success_url = reverse_lazy('horizon:storage:snapshots:snapshots_tab')
...
class EncryptionDetailView(generic.TemplateView):
    ...
    page_title = _("Volume Encryption Details")
