...
from openstack_dashboard.dashboards.storage \
...
class IndexView(tabs.TabbedTableView):
    tab_group_class = vol_snapshot_tabs.SnapshotAndStrategyTabs
    template_name = 'storage/snapshots/index.html'
    page_title = _("Snapshots")
...
class UpdateView(forms.ModalFormView):
    ...
    submit_url = "horizon:storage:snapshots:update"
...
class DetailView(tabs.TabView):
    ...
    page_title = _("Volume Snapshot Details")
