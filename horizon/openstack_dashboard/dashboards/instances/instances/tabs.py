...
from openstack_dashboard.dashboards.instances.instances import console


class OverviewTab(tabs.Tab):
    name = _("Overview")
    slug = "overview"
    template_name = ("instances/instances/"
...
class LogTab(tabs.Tab):
    name = _("Log")
    slug = "log"
    template_name = "instances/instances/_detail_log.html"
    preload = False
...
class ConsoleTab(tabs.Tab):
    name = _("Console")
    slug = "console"
    template_name = "instances/instances/_detail_console.html"
    preload = False
    ...
    def get_context_data(self, request):
        ...
        try:
            ...
            if console_type == "SERIAL":
                console_url = "/instances/instances/%s/serial" % (instance.id)
...
class AuditTab(tabs.TableTab):
    ...
    template_name = "instances/instances/_detail_audit.html"
    preload = False
...
class InstanceDetailTabs(tabs.TabGroup):
    ...
    tabs = (OverviewTab, ConsoleTab, MonitoringTab, AuditTab)
    sticky = True
