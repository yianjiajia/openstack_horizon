...
VIEW_MOD = 'openstack_dashboard.dashboards.instances.instances.views'
...
urlpatterns = patterns(
    ...
    url(r'^launchISV$', views.LaunchInstanceIsvView.as_view(), name='launchISV'),
    url(r'^(?P<instance_id>[^/]+)/$',
    ...
    url(INSTANCES % 'reset_password', views.ResetPasswordView.as_view(), name='reset_password'),
