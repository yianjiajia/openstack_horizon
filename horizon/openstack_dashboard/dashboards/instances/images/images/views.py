...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'instances/images/images/create.html'
    context_object_name = 'image'
    success_url = reverse_lazy("horizon:instances:images:index")
    page_title = _("Create An Image")


class UpdateView(forms.ModalFormView):
    form_class = project_forms.UpdateImageForm
    template_name = 'instances/images/images/update.html'
    success_url = reverse_lazy("horizon:instances:images:index")
    ...
    def get_object(self):
        try:
            ...
            url = reverse('horizon:instances:images:index')
    ...
    def get_initial(self):
        ...
        return {'image_id': self.kwargs['image_id'],
                ...
                'is_allow_inject_passwd': getattr(image, 'is_allow_inject_passwd', None),
                'protected': getattr(image, 'protected', None)}


class DetailView(tabs.TabView):
    tab_group_class = project_tabs.ImageDetailTabs
    template_name = 'instances/images/images/detail.html'
    ...
    def get_redirect_url():
        return reverse_lazy('horizon:instances:images:index')
