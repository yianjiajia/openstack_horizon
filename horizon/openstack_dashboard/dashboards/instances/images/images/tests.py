...
from openstack_dashboard.dashboards.instances.images.images import forms
from openstack_dashboard.dashboards.instances.images.images import tables


IMAGES_INDEX_URL = reverse('horizon:instances:images:index')
...
class UpdateImageFormTests(test.TestCase):
    ...
    def test_image_update(self):
        ...
        url = reverse('horizon:instances:images:images:update',
                      args=[image.id])
...
class ImageViewTests(test.TestCase):
    def test_image_create_get(self):
        url = reverse('horizon:instances:images:images:create')
        res = self.client.get(url)
        self.assertTemplateUsed(res,
                                'instances/images/images/create.html')
    ...
    def test_image_detail_get(self):
        ...
        res = self.client.get(reverse('horizon:instances:images:images:detail',
                                      args=[image.id]))

        self.assertTemplateUsed(res,
                                'instances/images/images/detail.html')
    ...
    def test_protected_image_detail_get(self):
        ...
        res = self.client.get(
            reverse('horizon:instances:images:images:detail',
                    args=[image.id]))
        self.assertTemplateUsed(res,
                                'instances/images/images/detail.html')
        self.assertEqual(res.context['image'].protected, image.protected)
    ...
    def test_image_detail_get_with_exception(self):
        ...
        url = reverse('horizon:instances:images:images:detail',
                      args=[image.id])
        res = self.client.get(url)
    ...
    def test_image_update_get(self):
        ...
        res = self.client.get(
            reverse('horizon:instances:images:images:update',
                    args=[image.id]))

        self.assertTemplateUsed(res,
                                'instances/images/images/_update.html')
        self.assertEqual(res.context['image'].name, image.name)
