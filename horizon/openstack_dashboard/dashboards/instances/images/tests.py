...
INDEX_URL = reverse('horizon:instances:images:index')
CREATE_URL = reverse('horizon:instances:images:images:create')
...
class ImagesAndSnapshotsTests(test.TestCase):
    ...
    def test_index(self):
        ...
        self.assertTemplateUsed(res, 'instances/images/index.html')
