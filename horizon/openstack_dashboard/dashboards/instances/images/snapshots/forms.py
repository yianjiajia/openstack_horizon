...
class CreateSnapshot(forms.SelfHandlingForm):
    ...
    def handle(self, request, data):
        try:
            ...
            # operation log
            config = _("Snapshot Name: %s Instance Name: %s") % (data['name'], instance.name)
            api.logger.Logger(request).create(resource_type='instance', action_name='Create Instance Snapshot',
