...
class MigrateInstance(policy.PolicyTargetMixin, tables.BatchAction):
    ...
    def action(self, request, obj_id):
        ...
        # operation log
        config = '\n'.join(['Instance ID: '+ obj_id])
        api.logger.Logger(request).create(resource_type='instance', action_name='Migrate Instance',
...
class AdminInstancesTable(tables.DataTable):
    ...
    memory_mb = tables.Column(project_tables.get_memory_gb,
                       verbose_name=_("memory_mb"))
    '''
    ...
    class Meta(object):
        ...
        row_actions = (project_tables.StartInstance,
                       ...
                       project_tables.ResetInstanceActive,
