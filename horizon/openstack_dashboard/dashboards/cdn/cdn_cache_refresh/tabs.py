...
class URLRefreshTab(tabs.Tab):
    name = _("URL Fresh")
    template_name = 'cdn/cdn_cache_refresh/url_refresh.html'
    slug = "url_refresh"
    submit_url = reverse_lazy('horizon:cdn:cdn_cache_refresh:urlfresh')
    preload = False
...
class DirectoryRefreshTab(tabs.Tab):
    ...
    template_name = "cdn/cdn_cache_refresh/dir_refresh.html"
    slug = "directory_refresh"
    submit_url = reverse_lazy('horizon:cdn:cdn_cache_refresh:dirfresh')
    preload = False
