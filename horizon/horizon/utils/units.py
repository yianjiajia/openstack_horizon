...
def get_vcpus_choices(is_test=False):
    normal = [('2', '2'),  ('4', '4'), ('8', '8'), ('16', '16'), ('24', '24'), ('32', '32')]
    if is_test:
        normal = [('1', '1')] + normal
    return normal

def get_memory_choices(is_test=False):
    normal = [('2048', '2G'), ('4096', '4G'), ('8192', '8G'), ('16384', '16G'), ('32768', '32G'), ('65536', '64G')]
    if is_test:
        normal = [('128', '128M'), ('256', '256M'), ('512', '512M'), ('1024', '1G')] + normal
    return normal
